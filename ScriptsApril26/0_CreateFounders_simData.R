...
createArray(array_name = 'Data/BigArray', array_number = 1, nChr = 16, segSites = rep(3200, 16), nSNPPerChr = rep(3200, 16), pop = founderGenomes)
#save array
array = colnames(pullSnpGeno(pop = founderGenomes, snpChip = 1, simParam = SP))
write.table(array, "Data/Bigarray.txt", sep = " ", na = "NA", quote = F, row.names = FALSE, col.names = FALSE)
