...
for (n in 1:nrow(nSNP_array)){
  ...
  NoGE_ped <- read.table(paste0("Data/Sim_NoGE/SNP_", nSNP_array[n,2], "_NoGE.ped"))
  GE_ped <- cbind(NoGE_ped[,c(1:6)], GE_ped_format)
  write.table(GE_ped, file= paste0("Data/Sim_WithGE/SNP_", nSNP_array[n,2], "_WithGE.ped"))
