...
for (i in 1:16) {
  beagle_cmd <- paste0(
    "java -jar ", pathToBeagle, "/beagle.4.0.jar gt=Data/Real_data/Slov_fM_QC_ACformat_sorted_biallelic_noDupPos.vcf.gz out=Outputs/Beagle_phasing/Slov_PHASED_chr", 
