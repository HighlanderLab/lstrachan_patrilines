...
for (n in 1:5){ 
  ...
  write.table(AlphaGeno_id, file=paste0(repDir, "Data/AlphaAssign/AlphaGeno_SNP",n,"_WithGE.txt"), sep=" ", quote=FALSE, col.names=FALSE, row.names=FALSE) 
}
setwd(repDir)
...
for (n in 1:5){ 
  ...
  write.table(AlphaGeno_id, file=paste0(repDir, "Data/AlphaAssign/AlphaGeno_SNP",n,"_NoGE.txt"), sep=" ", quote=FALSE, col.names=FALSE, row.names=FALSE) 
}
setwd(repDir)
